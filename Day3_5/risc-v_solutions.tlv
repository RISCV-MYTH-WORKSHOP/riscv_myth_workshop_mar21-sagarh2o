...
\TLV
   ...
   |cpu
      ...
      @1   
         ...
         $opcode_valid = $is_r_instr || $is_s_instr || $is_b_instr || $is_u_instr || $is_j_instr || $is_i_instr ;
         ?$opcode_valid
         ...
         `BOGUS_USE($is_beq $is_bne $is_blt $is_bge $is_bltu $is_bgeu $is_addi $is_add $start)
